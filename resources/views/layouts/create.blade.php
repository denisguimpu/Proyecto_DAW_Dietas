    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-8">
                <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-4">Crear Nueva Dieta</h2>
                <form action="{{ route('diets.store') }}" method="POST">
                    @csrf

                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Nombre de la dieta:</label>
                        <input type="text" name="name" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Ej: Dieta Hiperproteica Lunes">
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-bold mb-4">Selecciona los Ingredientes que componen la dieta:</label>
